...
from project_def import project_draw
...
def run(
    ...
    if is_file:
        if source[-3:] in VID_FORMATS:
            ...
            print('이미지')
            drivable_list = hybridnets_img(w='./HybridNets_main/weights/hybridnets.pth', source1=source,
                                           output1='./runs/detect')  # 리스트로 받아옴
    print(IMG_FORMATS)
    # =================================================================================================================
    ...
    for path, im, im0s, vid_cap, s in dataset:
        cv2.imwrite('C:/Users/KUser/PycharmProjects/HybridNets-main/yolov5-master/result_img/ori_img/0.jpg', im0s)
        with dt[0]:
...
######################################################################################################################
            ...
            im0=project_draw(det, save_txt, gn, save_conf, txt_path, save_img, save_crop, view_img, hide_labels, names,
                         hide_conf, im0, annotator, imc, save_dir, drivable_list)
            cv2.imwrite('C:/Users/KUser/PycharmProjects/HybridNets-main/yolov5-master/result_img/0.jpg', im0)
...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        #self.lane.clicked.connect(self.run_yolo_hybrid)  # 외각선 검출 이벤트
        ...
        #self.lane_inside.clicked.connect(self.run_yolo_hybrid)  # 외각선 안쪽 이벤트
...
#버튼 눌렀을때 실행되는 함수들---------------------------------------------------------------------------------
    ...
    def run_yolo_hybrid_def(self):
        run(weights='project_files/project.pt',source=self.fname[0],data='project_files/project.yaml')
        self.pixmap = QPixmap('C:/Users/KUser/PycharmProjects/HybridNets-main/yolov5-master/result_img/0.jpg')
        self.label.setPixmap(self.pixmap)
        self.label.setContentsMargins(10, 10, 10, 10)
        self.label.resize(self.pixmap.width(), self.pixmap.height())
    def result_def(self):
    ...
    def ori_img_def(self):
        self.pixmap = QPixmap('C:/Users/KUser/PycharmProjects/HybridNets-main/yolov5-master/result_img/ori_img/0.jpg')
        self.label.setPixmap(self.pixmap)
        self.label.setContentsMargins(10, 10, 10, 10)
        self.label.resize(self.pixmap.width(), self.pixmap.height())
    def yolov5_img_def(self):
        self.pixmap = QPixmap('C:/Users/KUser/PycharmProjects/HybridNets-main/yolov5-master/result_img/yolov5_img/0.jpg')
        self.label.setPixmap(self.pixmap)
        self.label.setContentsMargins(10, 10, 10, 10)
        self.label.resize(self.pixmap.width(), self.pixmap.height())
    def hybridnets_img_def(self):
        self.pixmap = QPixmap('C:/Users/KUser/PycharmProjects/HybridNets-main/yolov5-master/result_img/hybridnets_seg_img/0.jpg')
        self.label.setPixmap(self.pixmap)
        self.label.setContentsMargins(10, 10, 10, 10)
        self.label.resize(self.pixmap.width(), self.pixmap.height())
    #def lane_img(self):
