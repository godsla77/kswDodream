...
def hybridnets_img(
    ...
    with torch.no_grad():
        ...
        if imwrite:
            cv2.imwrite(f'C:/Users/KUser/PycharmProjects/HybridNets-main/yolov5-master/result_img/hybridnets_seg_img/{i}.jpg', cv2.cvtColor(ori_imgs[i], cv2.COLOR_RGB2BGR))
